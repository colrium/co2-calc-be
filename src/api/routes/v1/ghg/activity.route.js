...
const controller = require('../../../controllers/ghg/activity.controller');
const { authorize, ADMIN, LOGGED_USER } = require('../../../middlewares/auth');
const { list, create, replace, update } = require('../../../validations/ghg/activity.validation');
...
router
	...
	/**
	 * @api {post} v1/activities Create Result
...
router
	.route('/:id')
	/**
	 * @api {get} v1/activities/:id Get Result
	...
	/**
	 * @api {put} v1/activities/:id Replace Result
	...
	/**
	 * @api {patch} v1/activities/:id Update Result
	...
	/**
	 * @api {patch} v1/activities/:id Delete Result
