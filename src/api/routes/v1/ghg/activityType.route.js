...
const { listActivityTypes, createActivityType, replaceActivityType, updateActivityType } = require('../../../validations/ghg/activityType.validation');
...
router
	 ...
	 */
	.get(authorize(LOGGED_USER), validate(listActivityTypes), controller.list)
	/**
	 * @api {post} v1/activityTypes Create ActivityType
	 ...
	 */
	.post(authorize(LOGGED_USER), validate(createActivityType), controller.create);

router
	.route('/:activityTypeId')
	/**
	 * @api {get} v1/activityTypes/:id Get ActivityType
	...
	/**
	 * @api {put} v1/activityTypes/:id Replace ActivityType
	 ...
	 * @apiError (Not Found 404)    NotFound     ActivityType does not exist
	 */
	.put(authorize(LOGGED_USER), validate(replaceActivityType), controller.replace)
	/**
	 * @api {patch} v1/activityTypes/:id Update ActivityType
	 ...
	 * @apiError (Not Found 404)    NotFound     ActivityType does not exist
	 */
	.patch(authorize(LOGGED_USER), validate(updateActivityType), controller.update)
	/**
	 * @api {patch} v1/activityTypes/:id Delete ActivityType
